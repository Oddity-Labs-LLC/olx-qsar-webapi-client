...
class AboutTextPair(BaseModel):
    """
    AboutTextPair
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, alias="_label")
    value: Optional[StrictStr] = Field(default=None, alias="_value")
    __properties: ClassVar[List[str]] = ["_label", "_value"]
